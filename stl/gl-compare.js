! function r(s, h, u) {
    ...
    1: [function(e, t, n) {
        ...
        function i(e, t, n, i) {
            if (this.options = i || {}, this._mapA = e, this._mapB = t, this._horizontal = "horizontal" === this.options.orientation, this._onDown = this._onDown.bind(this), this._onMove = this._onMove.bind(this), this._onMouseUp = this._onMouseUp.bind(this), this._onTouchEnd = this._onTouchEnd.bind(this), this._ev = new h, this._swiper = document.createElement("div"), this._swiper.className = this._horizontal ? "compare-swiper-horizontal" : "compare-swiper-vertical", this._controlContainer = document.createElement("div"), this._controlContainer.className = this._horizontal ? "mapboxgl-compare mapboxgl-compare-horizontal" : "mapboxgl-compare", this._controlContainer.className = this._controlContainer.className, this._controlContainer.appendChild(this._swiper), "string" == typeof n && document.body.querySelectorAll) {
            ...
            this._setPosition(r), this._clearSync = s(e, t), this._onResize = function() {
    ...
    3: [function(e, t, n) {
        ...
        function v(e, t, n) {
            ...
            if (!i) return [];
            var o = i[t];
            return o ? "function" == typeof o ? n ? [o.listener || o] : [o] : n ? function(e) {
        ...
        }) : i.defaultMaxListeners = h, i.prototype.setMaxListeners = function(e) {
                ...
                case 1:
                    ! function(e, t, n) {
                        if (t) e.call(n);
                            ...
                            for (var i = e.length, o = _(e, i), r = 0; r < i; ++r) o[r].call(n)
                    }(r, f, this);
                    break;
                case 2:
                    ! function(e, t, n, i) {
                        if (t) e.call(n, i);
                            ...
                            for (var o = e.length, r = _(e, o), s = 0; s < o; ++s) r[s].call(n, i)
                    }(r, f, this, t);
                    break;
                case 3:
                    ! function(e, t, n, i, o) {
                        if (t) e.call(n, i, o);
                            ...
                            for (var r = e.length, s = _(e, r), h = 0; h < r; ++h) s[h].call(n, i, o)
                    }(r, f, this, t, n);
                    break;
                case 4:
                    ! function(e, t, n, i, o, r) {
                        if (t) e.call(n, i, o, r);
                            ...
                            for (var s = e.length, h = _(e, s), u = 0; u < s; ++u) h[u].call(n, i, o, r)
                    }(r, f, this, t, n, i);
                    break;
                default:
                    ...
                    ! function(e, t, n, i) {
                        if (t) e.apply(n, i);
                            ...
                            for (var o = e.length, r = _(e, o), s = 0; s < o; ++s) r[s].apply(n, i)
                    }(r, f, this, h)
            }
            return !0
